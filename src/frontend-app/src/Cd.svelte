<script>
    ...
    let filteredProdutos_cd = []; // Armazena os produtos filtrados
  ...
  function removerCarrinho(idProduto) {
    ...
    const searchProdutos = () => {
      if (searchQuery.trim() === '') {
        filteredProdutos_cd = produtos_cd;// Se não houver pesquisa, mostra todos os produtos
      } else {
  ...
  <main>
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
          <div>
            ...
            <li class="list-group-item"><a href="./disco.html">DISCOS</a></li>
            {#if usuarioLogado}
      ...
      <div class="container cardcarousel">
        ...
        <div class="container">
            ...
            {#each produtos_cd as linha_produto_cd}
